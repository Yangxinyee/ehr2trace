...
| ICU 转科 `visit_detail` | 0 | 源 1,523,224 行按跨分区去重后全部发布；四组格式指纹一致 |
...
JHU CTPE、MIMIC-IV 的 yaml 与准备脚本、阶段 0 的检查与故障注入、fixture 陷阱（T1.12）、三个数据集的正式重建与对比（阶段 3），以及 README 与论文的数字更新（T5.2、T5.3）。
