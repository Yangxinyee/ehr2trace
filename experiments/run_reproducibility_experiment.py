...
from ehr2trace.digest import changed, fingerprint  # noqa: E402
...
def main() -> None:
    ...
    ap.add_argument("--software-commit", default=None,
                    help="the software commit the builds and checks ran, recorded verbatim")
    ...
    summary = {
        ...
        # Which code was measured. CODE_VERSION alone is not enough: a change confined to the
        # canonical layer moves the canonical schema version and leaves CODE_VERSION as it was.
        "software_commit": args.software_commit,
        "code_version": CODE_VERSION,
        # A build with a vocabulary publishes concepts and runs the checks that judge them;
        # one without skips those, so records made each way are not comparable.
        "vocabulary_installed": args.vocab is not None,
