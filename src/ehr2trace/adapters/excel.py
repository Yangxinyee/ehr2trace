...
from ehr2trace.adapters.base import PhysicalUnit, RowStream, is_unnamed, normalize_header
from ehr2trace.config import AdapterOptions
from ehr2trace.registry import register_adapter
...
def get_adapter(name: str):
    from ehr2trace.registry import ADAPTERS
